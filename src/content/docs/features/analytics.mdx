...
<ThemedImage light="/images/gifs/reports-overview-light.gif" dark="/images/gifs/reports-overview-dark.gif" alt="Reports and analytics overview — daily reports, tax reports, and payment breakdowns" />

## Shop-Level Dashboards <TierBadge tier="starter" />

### KPI Dashboard

<ThemedImage light="/images/screenshots/light/desktop/analytics.png" dark="/images/screenshots/dark/desktop/analytics.png" alt="RepairOps Analytics dashboard with revenue, throughput, and turnaround metrics" />
...
<ThemedImage light="/images/screenshots/light/desktop/heartbeat.png" dark="/images/screenshots/dark/desktop/heartbeat.png" alt="RepairOps Heartbeat monitor showing real-time shop activity" />
...
<ThemedImage light="/images/screenshots/light/desktop/report-day.png" dark="/images/screenshots/dark/desktop/report-day.png" alt="RepairOps Day Report with daily revenue and ticket summary" />

<ThemedImage light="/images/screenshots/light/desktop/report-tax.png" dark="/images/screenshots/dark/desktop/report-tax.png" alt="RepairOps Sales Tax Report" />

<ThemedImage light="/images/screenshots/light/desktop/report-payment-types.png" dark="/images/screenshots/dark/desktop/report-payment-types.png" alt="RepairOps Payment Types breakdown report" />
