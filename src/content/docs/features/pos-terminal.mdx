...
<ThemedImage light="/images/screenshots/light/desktop/plugin-pos-terminal.png" dark="/images/screenshots/dark/desktop/plugin-pos-terminal.png" alt="RepairOps POS Terminal for processing non-repair sales" />
